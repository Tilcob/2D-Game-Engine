...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("2D-Game-Engine");
        ...
        configuration.setWindowedMode((int) Constants.WIDTH * Constants.WINDOW_FACTOR, (int) Constants.WIDTH * Constants.WINDOW_FACTOR);
